...
Java AI 低代码 / 零代码后台平台。它的特点不是单纯写 CRUD，而是把代码生成、在线表单、报表、流程、AI Skills、MCP 插件和企业后台基础能力结合起来。
...
| Spring Boot + Vue3 | 国内 Java 后台常见技术组合 | 适合 Java 团队学习和二开 |
| Shiro + JWT 权限 | 权限体系不同于 Spring Security 路线 | 可和 RuoYi/Yudao 对比 |
| JimuReport / JimuBI | 报表和 BI 能力嵌入后台平台 | 学企业后台报表平台化 |
| AI Skills / MCP | README 描述包含 AI 生成、知识库、流程编排、插件能力 | 学传统低代码平台向 AI 平台演进 |
...
3. 重点深读代码生成、在线表单、JimuReport、AI Skills。
