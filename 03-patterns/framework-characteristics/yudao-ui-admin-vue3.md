...
Yudao/RuoYi 体系的单应用 Vue3 管理后台前端。它更适合快速二开业务页面：列表、表单、审批、支付、商城、CRM、ERP、BPM 等模块都集中在一个前端工程里。
...
| Vue3 + Vite + TypeScript | 现代 Vue 工程基础 | 适合快速理解 Yudao 前端 |
...
- [[03-patterns/framework-characteristics/yudao-ui-admin-vben|yudao-ui-admin-vben 特点]]
- [[04-comparisons/yudao-ui-admin-vue3-vs-vben|yudao-ui-admin-vue3 与 yudao-ui-admin-vben 对比]]
