...
这里保存同类开源项目、框架、工具和技术路线的横向比较，用来支持选型判断。

## 推荐写法

- 先给结论，再给证据。
- 明确比较维度，不只比较 Star 数。
- 区分项目定位、技术栈、部署复杂度、扩展性、许可证、生态和学习价值。
- 如果信息来自当前 GitHub 状态，记录查询日期。
...
| Yudao 单体版与 Cloud 版对比 | `zhijiantianya/ruoyi-vue-pro`、`zhijiantianya/yudao-cloud` | 草稿 | [[04-comparisons/yudao-monolith-vs-cloud|yudao-monolith-vs-cloud]] |
...
| 后端项目一对一对比 | 当前已收录 7 个后台/后端/后台平台项目 | 草稿 | [[04-comparisons/pairwise-backend-comparisons|pairwise-backend-comparisons]] |
