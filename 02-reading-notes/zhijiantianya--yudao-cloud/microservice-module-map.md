...
建立 Cloud 版的第一张工程地图，明确它和 [[02-reading-notes/zhijiantianya--ruoyi-vue-pro/maven-module-structure|ruoyi-vue-pro Maven 多模块结构]] 的差异。
...
- 单体版模块地图：[[02-reading-notes/zhijiantianya--ruoyi-vue-pro/maven-module-structure|ruoyi-vue-pro - Maven 多模块结构]]
- 框架特点：[[03-patterns/framework-characteristics/yudao-cloud|Yudao Cloud 特点]]
- 对比文档：[[04-comparisons/yudao-monolith-vs-cloud|Yudao 单体版与 Cloud 版对比]]
